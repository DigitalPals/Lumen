...
pub enum AppIconSource {
    /// Lumen's curated symbolic icons matched by app name.
    #[default]
    Mapped,
...
#[lumen_config(bar_button, i18n_prefix = "settings-modules-volume")]
pub struct VolumeConfig {
    ...
    #[default(ClickAction::Shell(String::from("lumen audio output-mute")))]
