...
#[lumen_config(bar_button, i18n_prefix = "settings-modules-idle-inhibit")]
pub struct IdleInhibitConfig {
    ...
    #[default(ClickAction::Shell(String::from("lumen idle toggle --indefinite")))]
    pub left_click: ConfigProperty<ClickAction>,

    /// Action on right click. Default toggles timed idle inhibit.
    #[serde(rename = "right-click")]
    #[default(ClickAction::Shell(String::from("lumen idle toggle")))]
