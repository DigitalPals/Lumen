...
#[lumen_enum(default)]
pub enum IconSource {
    /// Use per-notification images when provided, otherwise Lumen's mapped icon.
    #[default]
    Automatic,
    /// Always use Lumen's mapped icons regardless of what the app provides.
    Mapped,
