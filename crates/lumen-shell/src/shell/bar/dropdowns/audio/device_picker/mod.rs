...
pub(crate) struct DevicePicker {
    ...
    cached_output_devices: Vec<Arc<lumen_audio::core::device::output::OutputDevice>>,
    cached_input_devices: Vec<Arc<lumen_audio::core::device::input::InputDevice>>,
}
    ...
    view! {
        ...
        gtk::Box {
            ...
            gtk::Box {
                ...
                #[template]
                lumen_widgets::prelude::GhostIconButton {
