...
use gtk::prelude::*;
use lumen_config::schemas::modules::{ActiveIndicator, DisplayMode, UrgentMode};
...
///
/// [`app-icons-dedupe`]: lumen_config::schemas::modules::NiriWorkspacesConfig::app_icons_dedupe
#[derive(Debug, Clone)]
