...
pub(super) fn apply_styling(
    ...
    let active_color = resolve_color(&ws_config.active_color, is_lumen_theme);
    let occupied_color = resolve_color(&ws_config.occupied_color, is_lumen_theme);
    let empty_color = resolve_color(&ws_config.empty_color, is_lumen_theme);
    let container_bg_color = resolve_color(&ws_config.container_bg_color, is_lumen_theme);
    let border_color = resolve_color(&ws_config.border_color, is_lumen_theme);
