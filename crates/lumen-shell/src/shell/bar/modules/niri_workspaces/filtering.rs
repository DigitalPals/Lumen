...
//!
//! Workspaces are shown unless explicitly ignored, filtered by monitor, or hidden
//! by `hide-trailing-empty`. Niri already reports real workspaces, so no
//! placeholder workspaces are fabricated.
...
mod tests {
    ...
    #[test]
    fn shows_empty_workspaces_when_trailing_empty_is_not_hidden() {
        let snapshots = vec![
            occupied(1, 1, "DP-1"),
            empty(2, 2, "DP-1"),
            occupied(3, 3, "DP-1"),
