...
use lumen_widgets::styling::resolve_color;
use relm4::gtk;
...
pub(super) fn apply_styling(
    ...
    let is_lumen_theme = matches!(styling.theme_provider.get(), ThemeProvider::Lumen);
    let color = resolve_color(&config.color, is_lumen_theme);
