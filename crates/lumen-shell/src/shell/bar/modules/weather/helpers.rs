use lumen_config::schemas::modules::TemperatureUnit as ConfigTempUnit;
use lumen_weather::{Temperature, TemperatureUnit, Weather, WeatherCondition};
use serde_json::json;
...
pub(crate) fn format_speed(speed: lumen_weather::Speed, units: TemperatureUnit) -> String {
    match units {
