...
use lumen_config::schemas::wallpaper::MonitorWallpaperConfig;
use lumen_wallpaper::{
...
pub(super) async fn build_wallpaper_service(
    cfg: &lumen_config::schemas::wallpaper::WallpaperConfig,
    theming_monitor: Option<String>,
    color_extractor: ColorExtractorConfig,
) -> Result<Arc<WallpaperService>, lumen_wallpaper::Error> {
