...
use lumen_config::{ConfigService, infrastructure::schema};
use lumen_core::{DeferredService, Property};
use lumen_hyprland::HyprlandService;
use lumen_ipc::shell::APP_ID;
...
use lumen_systray::{SystemTrayService, types::TrayMode};
...
async fn init_daemon_services(
    timer: &StartupTimer,
    modules: &lumen_config::schemas::modules::ModulesConfig,
) -> DaemonServices {
