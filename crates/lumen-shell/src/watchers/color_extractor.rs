...
use lumen_config::schemas::styling::{StylingConfig, ThemeProvider};
use lumen_wallpaper::{ColorExtractor, ColorExtractorConfig};
...
pub(crate) fn build_extractor_config(styling: &StylingConfig) -> ColorExtractorConfig {
    ColorExtractorConfig {
        tool: match styling.theme_provider.get() {
            ThemeProvider::Lumen => ColorExtractor::None,
