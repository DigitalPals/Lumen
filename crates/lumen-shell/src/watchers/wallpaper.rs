...
use lumen_config::schemas::wallpaper::{MonitorWallpaperConfig, WallpaperConfig};
use lumen_wallpaper::{TransitionConfig, TransitionDuration, TransitionFps, WallpaperService};
use tracing::warn;
