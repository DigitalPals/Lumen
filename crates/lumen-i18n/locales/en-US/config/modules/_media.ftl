### Lumen Configuration - Media Module
...
settings-modules-media-hide-when-nothing-playing = Hide When Nothing Playing
    .description = Hide the module unless media is currently playing
