...
/// key; fields with `#[lumen(skip)]` are excluded. A `#[lumen(deprecated_alias)]`
...
pub fn apply_config_layer(input: TokenStream) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::ApplyConfigLayer for #struct_name {
...
pub fn apply_runtime_layer(input: TokenStream) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::ApplyRuntimeLayer for #struct_name {
...
pub fn extract_runtime_values(input: TokenStream) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::ExtractRuntimeValues for #struct_name {
...
pub fn subscribe_changes(input: TokenStream) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::SubscribeChanges for #struct_name {
...
///
/// Currently only used by the CLI (`lumen config reset <path>`).
pub fn clear_runtime_by_path(input: TokenStream) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::ClearRuntimeByPath for #struct_name {
...
pub fn simple_field_walk(input: TokenStream, trait_name: &str, method_name: &str) -> TokenStream {
    ...
    let generated = quote! {
        impl lumen_config::#trait_ident for #struct_name {
