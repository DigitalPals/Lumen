...
//!
//! ```rust,no_run
//! # use lumen_wallpaper::{WallpaperService, CyclingMode};
//! # use std::path::PathBuf;
...
//!
//! ```rust,no_run
//! use lumen_wallpaper::{WallpaperService, TransitionConfig, TransitionType};
//!
//! # async fn example() -> Result<(), lumen_wallpaper::Error> {
...
//! # Reactive Properties
//!
//! All fields are [`Property<T>`](lumen_core::Property):
