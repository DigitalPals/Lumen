...
impl ConfigPaths {
    /// Configuration directory path (`$XDG_CONFIG_HOME/lumen` or `~/.config/lumen`).
    ///
    /// # Errors
    ///
    ...
    pub fn config_dir() -> Result<PathBuf, Error> {
        ...
        Ok(PathBuf::from(config_home).join("lumen"))
    }

    /// Data directory (`$XDG_DATA_HOME/lumen` or `~/.local/share/lumen`).
    ...
    pub fn data_dir() -> Result<PathBuf, Error> {
        ...
        let data_dir = PathBuf::from(data_home).join("lumen");
    ...
    /// State directory (`$XDG_STATE_HOME/lumen` or `~/.local/state/lumen`).
    /// Creates directory if absent.
    ///
    /// # Errors
    ///
    ...
    pub fn state_dir() -> Result<PathBuf, Error> {
        ...
        let state_dir = PathBuf::from(state_home).join("lumen");
    ...
    /// Log directory (`$XDG_STATE_HOME/lumen` or `~/.local/state/lumen`).
    /// Creates directory if absent.
    ///
    /// # Errors
    ///
    ...
    /// Cache directory (`$XDG_CACHE_HOME/lumen` or `~/.cache/lumen`).
    /// Creates directory if absent.
    ///
    /// # Errors
    ///
    ...
    pub fn cache_dir() -> Result<PathBuf, Error> {
        ...
        let cache_dir = PathBuf::from(cache_home).join("lumen");
