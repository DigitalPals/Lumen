...
pub const SERVICE_NAME: &str = "com.lumen.IdleInhibit1";
pub const SERVICE_PATH: &str = "/com/lumen/IdleInhibit";

#[proxy(
    interface = "com.lumen.IdleInhibit1",
    default_service = "com.lumen.IdleInhibit1",
    default_path = "/com/lumen/IdleInhibit",
    gen_blocking = false
)]
