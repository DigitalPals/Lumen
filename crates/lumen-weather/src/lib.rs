...
//!
//! ```rust,no_run
//! use lumen_weather::{WeatherService, WeatherProviderKind, LocationQuery, TemperatureUnit};
...
//! # Reactive Properties
//!
//! The `weather` field is a [`Property<Option<Arc<Weather>>>`](lumen_core::Property):
