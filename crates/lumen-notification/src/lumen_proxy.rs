//! D-Bus client proxy for Lumen notification extensions.
#![allow(missing_docs)]
...
#[proxy(
    ...
    default_service = "com.lumen.Notifications1",
    default_path = "/com/lumen/Notifications",
    gen_blocking = false
)]
pub trait LumenNotifications {
