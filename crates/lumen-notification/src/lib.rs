...
//! # Reactive Properties
//!
//! Service state is exposed through [`Property`](lumen_core::Property) fields:
...
//!
//! - **Service:** `com.lumen.Notifications1`
...
pub use error::Error;
pub use lumen_proxy::LumenNotificationsProxy;
