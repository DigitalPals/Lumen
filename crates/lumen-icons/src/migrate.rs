...
//!
//! Older lumen releases shipped icons that used GTK's Grappa stroke
...
///
/// The `>=` comparison preserves files written by a hypothetical future lumen
...
/// The contract is that newer lumen versions never emit files that cannot be
